...
import com.demo.gateway.hander.CustomReactiveAuthorizationManager;
import com.demo.gateway.hander.CustomServerAccessDeniedHandler;
...
public class ResourceServerConfig {
    ...
    public ReactiveJwtDecoder jwtDecoder() throws IOException, NoSuchAlgorithmException, InvalidKeySpecException {
        ...
        Resource resource = new ClassPathResource("new-authoriza-server-public-key.pem");
